...
public class LeaveAllocationsController : Controller
{
    ...
    public async Task<IActionResult> Create([Bind("NumberOfDays,LeaveTypeId,EmployeeId,Id,DateCreated,DateModified")] LeaveAllocation leaveAllocation)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int id, [Bind("NumberOfDays,LeaveTypeId,EmployeeId,Id,DateCreated,DateModified")] LeaveAllocation leaveAllocation)
    {
